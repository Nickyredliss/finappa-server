...
app.get("/health", (_req, res) => res.json({ ok: true, service: "finappa-server", rev: "26", advisor: !!process.env.ANTHROPIC_API_KEY }));
...
const emptyPersonal = () => ({
  wallets: [], categories: [], txs: [], subscriptions: [], drafts: [], goals: [], tasks: [], habits: [], wishes: [],
